...
int main(int argc, char* argv[]) {
    ...
    // Print the directory and the executable name for debugging
    std::cout << "Current directory: " << exePathStr.substr(0, exePathStr.find_last_of("\\/") + 1) << std::endl;
    std::cout << "Executable name: " << exePathStr.substr(exePathStr.find_last_of("\\/") + 1) << std::endl;
    ...
    // Print the target executable path for debugging
    std::cout << "Executable name to run: " << exePathStr << std::endl;
